...
DATABASE.execute("CREATE TABLE IF NOT EXISTS authors 
                  (id INTEGER PRIMARY KEY, 
                  name TEXT)")

DATABASE.execute("CREATE TABLE IF NOT EXISTS location_keys 
                  (id INTEGER PRIMARY KEY, 
...
DATABASE.execute("CREATE TABLE IF NOT EXISTS articles 
                  (id INTEGER PRIMARY KEY, 
                  date DATE, 
                  author INTEGER, 
                  title TEXT, 
